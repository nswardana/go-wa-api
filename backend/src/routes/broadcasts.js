...
router.get('/queue', authMiddleware, broadcastController.getQueueStatus); // Must come before /:id
router.get('/:id', authMiddleware, broadcastController.getBroadcast);
router.get('/:id/recipients', authMiddleware, broadcastController.getBroadcastRecipients); // Add recipients route
